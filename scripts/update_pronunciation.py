...
RULES = [
    ...
    {"string_to_replace": "Saifedean Ammous", "type": "alias", "alias": "sy-feh-DEAN AH-moos"},
    {"string_to_replace": "Saifedean", "type": "alias", "alias": "sy-feh-DEAN"},
    {"string_to_replace": "Ammous", "type": "alias", "alias": "AH-moos"},
    ...
    {"string_to_replace": "Jerome Powell", "type": "alias", "alias": "jeh-ROME POW-ul"},
    {"string_to_replace": "Powell", "type": "alias", "alias": "POW-ul"},
    ...
    # === Acronyms & Technical ===
    {"string_to_replace": "ETFs", "type": "alias", "alias": "E-T-Fs"},
    ...
    # === Pronunciation fixes ===
    {"string_to_replace": "fiat", "type": "alias", "alias": "fee-at"},
    {"string_to_replace": "Fiat", "type": "alias", "alias": "Fee-at"},
    {"string_to_replace": "FIAT", "type": "alias", "alias": "FEE-AT"},
    ...
    {"string_to_replace": "Coinbase", "type": "alias", "alias": "KOYN-base"},
    {"string_to_replace": "Binance", "type": "alias", "alias": "BY-nance"},
    {"string_to_replace": "Chainalysis", "type": "alias", "alias": "CHAIN-uh-LY-sis"},
