...
def generate_tweets(brief: dict, count: int = 1, length_override: str = "") -> list:
    ...
    try:
        ...
        from pp_services.x_service import get_banned_concepts
    ...
    try:
        from pp_services.x_service import get_available_angles, ANGLE_CATEGORIES
...
def main():
    ...
    for tweet in tweets:
        ...
        if CAN_POST:
            ...
            try:
                sys.path.insert(0, str(BASE))
                from pp_services.x_service import can_post_tweet, ANGLE_CATEGORIES
            ...
            if result.get("success"):
                ...
                # Cross-post to Nostr
                try:
                    from pp_services.social_broadcaster import post_to_nostr
