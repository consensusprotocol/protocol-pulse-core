...
def run(test_mode: bool = False):
    ...
    grok_clips = []
    try:
        from pp_services.video_engine.editorial.trend_scout import scout_trends, search_discovery_clips
    ...
    spaces_data = []
    try:
        from pp_services.video_engine.sources.spaces_listener import find_recent_spaces
    ...
    if triage.configured:
        ...
        from pp_services.video_engine.editorial.schemas import TriageOutput, CandidateMoment
    ...
    from pp_services.video_engine.editorial.schemas import ClusterOutput, StoryCluster
    ...
    # Nostr cards
    if nostr_posts:
        from pp_services.video_engine.sources.nostr_capture import render_nostr_card
    ...
    from pp_services.video_engine.sources.tweet_screenshot import capture_tweet
