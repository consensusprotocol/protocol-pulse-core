...
from pp_services.video_engine.assembly.local_assembler import LocalAssembler
from pp_services.video_engine.assembly.manifest_builder import ManifestBuilder
from pp_services.video_engine.editorial.schemas import AssemblyManifest, TimelineEntry
...
class EpisodeBuilder:
    ...
    def _generate_graphics(self) -> dict:
        ...
        try:
            from pp_services.video_engine.graphics.motion_graphics import (
    ...
    def _generate_thumbnail(self) -> Optional[str]:
        ...
        try:
            from pp_services.video_engine.graphics.thumbnail import (
                generate_thumbnail
            )
