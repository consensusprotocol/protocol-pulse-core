...
from pp_services.video_engine.pulse_distributor import distribute_pulse
from pp_services.video_engine.intel_feed_consumer import consume_intel_feeds
...
def start_scheduler():
    ...
    try:
        from pp_services.video_engine.pulse_alert import PulseAlertScheduler
