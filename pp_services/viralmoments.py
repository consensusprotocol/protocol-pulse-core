...
def _get_fallback_clip():
    ...
    from pp_services.clip_service import fallback_clip
...
class ViralMomentsReelEngine:
    ...
    def plan_segments(self, video_id: str, narration_path: Optional[str] = None) -> Dict:
        ...
        if WhisperModel is not None:
            ...
            local_source = None
            try:
                from pp_services.clip_service import _resolve_local_source  # type: ignore
        ...
        if not has_speech:
            ...
            try:
                from pp_services.clip_service import fallback_thumbnail_reel  # type: ignore
