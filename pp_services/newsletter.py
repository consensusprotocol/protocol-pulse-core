...
class NewsletterService:
    ...
    def subscribe_user(self, email: str, name: str = None) -> bool:
        ...
        try:
            ...
            def _send():
                try:
                    from pp_services.newsletter_service import _send_welcome_email
    ...
    def send_welcome_email(self, to_email: str, name: str = None) -> bool:
        ...
        try:
            ...
            html_content = f"""
            <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #e0e0e0;">
                <div style="background: linear-gradient(135deg, #0a0a0a, #111111); padding: 32px; text-align: center; border-bottom: 2px solid #00d4aa;">
                    <h1 style="color: #ffffff; font-size: 1.5rem; margin: 0;">Protocol Pulse</h1>
                    <p style="color: #00d4aa; font-family: monospace; font-size: 0.75rem; margin: 8px 0 0; letter-spacing: 0.1em;">INTELLIGENCE FOR TRANSACTORS</p>
                </div>
                <div style="padding: 32px;">
                    <h2 style="color: #ffffff; font-size: 1.25rem;">Welcome{display_name},</h2>
                    <p style="color: #a0a0a0; line-height: 1.7;">You're now connected to the Protocol Pulse intelligence network. Here's what to expect:</p>
                    <ul style="color: #a0a0a0; line-height: 2;">
                        <li>Daily Bitcoin network analysis & mining economics</li>
                        <li>AI-powered market signals & trend detection</li>
                        <li>Hashrate, difficulty & fee market reports</li>
                        <li>Sovereign wealth strategies & security updates</li>
                    </ul>
                    <p style="margin-top: 24px;"><a href="https://protocolpulse.io" style="display: inline-block; padding: 12px 24px; background: #00d4aa; color: #0a0a0a; text-decoration: none; border-radius: 6px; font-weight: 700;">Read Latest Intel</a></p>
                    <p style="color: #666; font-size: 0.8125rem; margin-top: 24px;">Stay sovereign,<br>The Protocol Pulse Team</p>
                </div>
            </div>
            """
    ...
    def send_newsletter(self, subject: str, content: str, recipients: list = None, 
        ...
        if not skip_fact_check:
            try:
                from pp_services.fact_checker import verify_article_before_publish
