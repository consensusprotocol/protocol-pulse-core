...
def _get_signal_fetcher():
    ...
    if _signal_fetcher is None:
        try:
            from pp_services.signal_data_fetcher import SignalDataFetcher
...
def _fetch_polymarket() -> dict:
    ...
    try:
        ...
        from pp_services.polymarket_service import (
            get_bitcoin_markets,
...
class SovereignContextEngine:
    ...
    def build_world_state(self) -> dict:
        ...
        pro_metrics = {}
        try:
            from pp_services.pro_metrics_service import fetch_all_pro_metrics
