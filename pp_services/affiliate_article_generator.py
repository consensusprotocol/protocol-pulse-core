...
"""
    ...
    def generate_affiliate_article(self, product_id: str = None, problem_index: int = None) -> Optional[Dict]:
        ...
        try:
            ...
            from pp_services.content_engine import content_engine
            ...
            from pp_services.content_generator import resolve_header_image_url
            header_img, src_url, src_type = resolve_header_image_url(final_title, content)

            with app.app_context():
                from pp_services.content_generator import auto_publish_enabled
