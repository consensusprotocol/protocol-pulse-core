...
def get_latest_signals():
    ...
    for key in signal_keys:
        row = (SignalNormalized.query
               .filter_by(signal_key=key, subject_id=subject_id)
...
def _compute_live_convergence():
    ...
    try:
        ...
        return jsonify({"error": "Convergence engine initializing", "detail": str(e)}), 503
...
def _compute_live_convergence_graph():
    ...
    try:
        ...
        return jsonify({"error": "Graph engine initializing"}), 503
