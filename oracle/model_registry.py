...
DEVICE = "cuda:0"  # physical GPU1 via CUDA_VISIBLE_DEVICES=1 in start_avatar_server.sh  # GPU 1 — avatar server exclusive. Pipeline on cuda:0 via CUDA_VISIBLE_DEVICES
