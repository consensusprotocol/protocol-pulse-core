...
from services.config_loader import get_enabled_channels, get_settings, load_channels_config, toggle_channel
...
def pulse_trigger():
    ...
    def _run_pipeline():
        try:
            from services.video_engine.daily_driver import DailyDriver
...
def pulse_alert_trigger():
    ...
    def _run_scan():
        try:
            from services.video_engine.pulse_alert import PulseAlert
            alert = PulseAlert()
