...
- **LAW 6: Proto-P avatar asset**
  - **COMPLIANT**: No code or documentation in the provided files suggests deviation from using `oracle/assets/Proto_P_Avatar_512.png` 
...
**What it is**: Global rate limit is 200 req/day per IP. The Oracle Avatar feature makes ElevenLabs TTS calls and potentially Wa
