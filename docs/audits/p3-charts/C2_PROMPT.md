...
- **PARTIAL ISSUE:** While WebSocket is used for mempool data, price updates fall back to a periodic fetch every 30s (charts.html:1783-1795) via `/api/charts/price-h
...
- **What:** If the API returns `data.prices = []`, functions like `drawPriceC
