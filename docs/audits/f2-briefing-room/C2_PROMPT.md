...
-   **Mobile:** Responsiveness is handled via media queries (lines 520-530), correctly ad
...
- Default rate limit is `200 per day` globally (`96`). That is likely too blunt and may break normal traffic while still no
