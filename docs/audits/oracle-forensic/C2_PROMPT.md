...
- **What to change:** The fix in U1 prevents `vid.onerror` from ever firing in this path. Additionally, the `onerror` handler should explicitly reset the video element state so recov
